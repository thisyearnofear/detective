...
async function main() {
  ...
  console.log('');
  console.log('Once payment is set up, your agent can:');
  console.log('');
  console.log('1. Start a negotiation match (paid)');
  console.log('2. Make proposals and negotiate');
  console.log('3. Accept/reject offers');
  console.log('4. Export match history (paid)');
  console.log('');
  console.log('Example negotiation flow:');
  console.log('');
  ...
  console.log('  proposal: { books: 2, hats: 1, balls: 1 }');
  console.log('});');
  console.log('');
