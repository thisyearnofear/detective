 ...
 * 4. User scans QR in Warpcast → Approves signin
 * 5. We poll for completion → Return profile + JWT token
 */
...
export default function FarcasterAuthKit({ onAuthSuccess, onExploreWithoutAuth }: Props) {
    ...
    // Step 1: Wallet connected → Initiate Farcaster signin
    useEffect(() => {
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-400">
                                Open Warpcast app → Scan → Approve signin request
                            </p>
                        </div>
